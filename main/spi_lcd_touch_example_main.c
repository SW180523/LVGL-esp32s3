...
#define EXAMPLE_PIN_NUM_SCLK           6//18
#define EXAMPLE_PIN_NUM_MOSI           8//19
#define EXAMPLE_PIN_NUM_MISO           GPIO_NUM_NC //21
#define EXAMPLE_PIN_NUM_LCD_DC        9 //5
#define EXAMPLE_PIN_NUM_LCD_RST        GPIO_NUM_NC//3
#define EXAMPLE_PIN_NUM_LCD_CS        7// 4
#define EXAMPLE_PIN_NUM_BK_LIGHT      3// 2
